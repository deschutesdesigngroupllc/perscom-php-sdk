...
test('it can get all users rank records', function () {
    $response = $this->connector->users()->rankRecords(1)->all();
...
test('it can get a users rank record', function () {
    $response = $this->connector->users()->rankRecords(1)->get(1);
...
test('it can create a users rank record', function () {
    $response = $this->connector->users()->rankRecords(1)->create([
        'foo' => 'bar',
    ]);
...
test('it can update a users rank record', function () {
    $response = $this->connector->users()->rankRecords(1)->update(1, [
        'foo' => 'bar',
    ]);
...
test('it can delete a users rank record', function () {
    $response = $this->connector->users()->rankRecords(1)->delete(1);
